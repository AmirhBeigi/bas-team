  ...
  <div class="bg-black">
    ...
    <div class="projects-page bg-black text-white py-28 xl:py-36">
      ...
      <section class="projects-section py-12 lg:py-16">
        <div
          class="container mx-auto lg:max-w-none xl:px-0 lg:w-93/100 flex flex-col gap-7 lg:gap-24"
        >
          <div
            v-for="(service, index) in services"
            :key="index"
            class="w-full flex justify-center items-center lg:items-start flex-col lg:flex-row gap-6"
          >
            <img :src="service.logo" />
            <div class="w-full">
              <h5
                class="border-b-2 border-green-500 pb-4 mb-4"
              ...
              <p class="text-sm text-justify opacity-60 mt-16">
                {{ service.mainCaption }}
              </p>
            </div>
          </div>
  ...
  data() {
    return {
      services: [
        ...
        {
          logo: require('../assets/img/social.png'),
          title: 'SOCIAL',
          color: '#27BD5A',
          mainCaption:
            'Lorem ipsum dolor sit amet, consectetuer adipiscing elit, sed diam nonummy nibh euismod tincidunt ut laoreet dolore magna aliquam erat volutpat. Ut wisi enim ad minim veniam, quis nostrud exerci tation ullamcorper suscipit lobortis nisl ut aliquip ex ea commodo consequat. Duis autem vel eum iriure dolor in hendrerit in vulputate velit esse molestie consequat, vel illum dolore eu feugiat nulla facilisis at vero eros et accumsan et iusto odio dignissim qui blandit praesent luptatum zzril delenit augue duis dolore te feugait nulla facilisi. dolore eu feugiat nulla facilisis at vero eros et accumsan et iusto odio dignissim qui blandit praesent luptatum zzril delenit augue duis dolore te feugait nulla facilisi.Lorem ipsum dolor sit amet, consectetuer adipiscing elit, sed diam nonummy nibh euismod tincidunt ut laoreet dolore magna aliquam erat volutpat. Ut wisi enim ad minim veniam, quis nostrud exerci tation ullamcorper suscipit lobortis nisl ut aliquip ex ea commodo consequat. Duis autem vel Lorem ipsum dolor sit amet, cons ectetuer adipiscing elit, sed diam nonummy nibh euismod tincidunt ut laoreet dolore magna aliquam erat volutpat. Ut wisi enim ad minim veniam, quis nostrud exerci tation ullamcorper suscipit lobortis nisl ut aliquip ex ea commodo consequat.',
